...
type FormProps = {
    onSubmit: (currentState: { protein: number; carbs: number; fats: number; }, formData: FormData) => Promise<{ protein: number; carbs: number; fats: number; }>;
}

export default function Form(props: FormProps) {
    const [macros, formAction] = useActionState<{ protein: number; carbs: number; fats: number }>(props.onSubmit, null);
    return (
